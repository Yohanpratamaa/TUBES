            ...
            <div class="flex">
                ...
                <div class="hidden mt-md-3 space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-dropdown align="right">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500">
                                <div style="margin-top: 4px">Chat</div>
                                <div class="ms-1" style="margin-top: 4px">
