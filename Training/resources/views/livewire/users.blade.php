<div class="py-3 overflow-visible">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
        <div class="bg-white overflow-visible shadow-sm sm:rounded-lg h-100">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 p-2 ">
                    ...
                    <div class="w-full bg-white border border-gray-200 rounded-lg p-5 shadow">
                        ...
                        <div class="flex flex-col items-center pb-10">
                            ...
                            <img src="https://picsum.photos/500/500?random-{{$key}}" alt="image" class="w-24 h-24 mb-2 5 rounded-full shadow-lg">
