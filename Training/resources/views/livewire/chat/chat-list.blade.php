                ...
                <aside class=" grid grid-cols-12 w-full">
                    ...
                    <a href="{{route('chat',$conversation->id)}}" class="col-span-11 border-b pb-2 border-gray-200 relative overflow-hidden truncate leading-5 w-full flex-nowrap p-1">
                        ...
                        <div class="flex justify-between w-full items-center">
                            ...
                            <h7 class="truncate font-small tracking-wider text-gray-900"> {{ $conversation->getReceiver()->name }}</h7>
                        ...
                        {{-- Pesan --}}
                            <p class="grow truncate text-sm font-[100]">
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Rerum iure facilis, impedit laboriosam labore voluptatem iusto illum, consequatur amet optio delectus debitis explicabo iste ipsum quia fugiat, blanditiis deleniti consectetur.
                             </p>
